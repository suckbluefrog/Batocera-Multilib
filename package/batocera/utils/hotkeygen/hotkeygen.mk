...
define HOTKEYGEN_INSTALL_TARGET_CMDS
	...
	install -m 0644 $(HOTKEYGEN_PATH)/conf/common_context.ally.conf $(TARGET_DIR)/usr/share/hotkeygen/common_context.ally.conf
	install -m 0644 $(HOTKEYGEN_PATH)/conf/specific/*.mapping $(TARGET_DIR)/usr/share/hotkeygen/
	install -m 0644 $(HOTKEYGEN_PATH)/conf/specific/*.mapping.es $(TARGET_DIR)/usr/share/hotkeygen/
	install -m 0644 $(HOTKEYGEN_PATH)/conf/specific/*.mapping.steam $(TARGET_DIR)/usr/share/hotkeygen/
