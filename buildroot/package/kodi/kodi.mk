...
define KODI_GENERATE_SKIN_PACKS
	mkdir -p $(@D)/buildroot-build/addons/skin.estuary/media
	$(HOST_DIR)/bin/kodi-TexturePacker \
		-input $(@D)/addons/skin.estuary/media \
		-output $(@D)/buildroot-build/addons/skin.estuary/media/Textures.xbt \
		-dupecheck
	$(HOST_DIR)/bin/kodi-TexturePacker \
		-input $(@D)/addons/skin.estuary/themes/curial \
		-output $(@D)/buildroot-build/addons/skin.estuary/media/curial.xbt \
		-dupecheck
	$(HOST_DIR)/bin/kodi-TexturePacker \
		-input $(@D)/addons/skin.estuary/themes/flat \
		-output $(@D)/buildroot-build/addons/skin.estuary/media/flat.xbt \
		-dupecheck
endef
KODI_PRE_INSTALL_STAGING_HOOKS += KODI_GENERATE_SKIN_PACKS
