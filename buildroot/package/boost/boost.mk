...
# 1.89 introduces boost-histogram/process build targets. Keep them disabled
# for 32-bit ARM multilib builds until we add explicit Config.in symbols with
# full dependency/select modeling.
ifeq ($(BR2_arm)$(BR2_armeb),y)
BOOST_WITHOUT_FLAGS += histogram
BOOST_WITHOUT_FLAGS += process
endif
