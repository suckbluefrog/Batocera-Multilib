...
OPENCV4_CONF_OPTS += \
	...
	-DBUILD_opencv_gapi=$(if $(BR2_PACKAGE_OPENCV4_DISABLE_GAPI),OFF,ON) \
...
# 32-bit ARMv8 toolchains can miss the vcvtn* NEON intrinsics used by
# carotene's rounding helpers, which breaks the build.
ifeq ($(BR2_arm)$(BR2_ARM_CPU_ARMV8A),yy)
OPENCV4_CONF_OPTS += -DWITH_CAROTENE=OFF
endif
