...
define XXHASH_FIXUP_STAGING_PC_FILE
	$(SED) 's%^prefix=/usr/local%prefix=/usr%' \
		$(STAGING_DIR)/usr/lib/pkgconfig/libxxhash.pc
endef

define XXHASH_FIXUP_TARGET_PC_FILE
	$(SED) 's%^prefix=/usr/local%prefix=/usr%' \
		$(TARGET_DIR)/usr/lib/pkgconfig/libxxhash.pc
endef

XXHASH_POST_INSTALL_STAGING_HOOKS += XXHASH_FIXUP_STAGING_PC_FILE
XXHASH_POST_INSTALL_TARGET_HOOKS += XXHASH_FIXUP_TARGET_PC_FILE
