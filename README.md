...
This build is intended for **advanced users** running 86-64-v3 –class  AMD excavator (2015) / Intel 4th gen haswell (2013) and above hardware and handheld devices with Wayland support.
